document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form) {
        form.addEventListener('submit', function(event) {
            ...
            if (!telefono || !nombres || !apellidoPaterno || !apellidoMaterno || !password || !dob || !terms) {
            ...
            fetch("https://973f29df-328d-4bcf-80f4-60c18a7bfd7a-00-2z1u5ktbg8j3k.riker.replit.dev/api/auth/signin", requestOptions)
            .then((response) => {
                if (!response.ok) {
